<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BoardAnswerInsert.aspx.cs" Inherits="WebApp.BoardAnswerInsert" %>
            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <asp:TextBox ID="Answer_Content" Width="300px" runat="server" ></asp:TextBox>
                    </td>
                    <td style="text-align:right;">
                         <%--<input type="button" value="댓글작성" style="width:100px;" onclick="checkContents()"/>--%>
                        <asp:button ID="insertBtn" Text="답변작성" runat="server" OnClick="insertBtn_Click" />
